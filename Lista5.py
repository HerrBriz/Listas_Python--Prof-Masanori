# Questão A. O que o seguinte programa (dado na forma de pseudocódigo) imprime?
# x = 2
# y = 5
# se y > 8, então
#   y = y * 2
...
# Questão B: Quantas vezes o trecho do pseudocódigo seguinte imprime "oi"? (obs: na pseudo-linguagem, o laço inclui os extremos,
...
lt = '''213752 216732 221063 221545 225583 229133 230648 233222
...
list = []
for i in lt:
    if not dc(i) and par(i) and i[0] != i[-1]:
        list.append(i)
print(len(list))
